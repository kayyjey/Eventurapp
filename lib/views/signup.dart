    ...
    return Scaffold(
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: 80,),
            Text("Sign Up",style: TextStyle(color: kLightGreen, fontSize: 32, fontWeight: FontWeight.w800),
            ),
            SizedBox(height: 8,),
            CustomInputForm(
            ...
            GestureDetector(
              ...
              child: Row(
                ...
                children: [
                  Text("Already have an account?", style: TextStyle(color: kLightGreen,fontSize: 16,fontWeight: FontWeight.w300),),
                  SizedBox(width: 4,),
                  Text("Login", style: TextStyle(color: kLightGreen,fontSize: 16,fontWeight: FontWeight.w600))
                ],
              ),
            )
          ],
